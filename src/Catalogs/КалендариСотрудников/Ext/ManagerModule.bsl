...
Функция КалендариСотрудниковОтмеченныеКакОсновнойУПользователя()
	...
	Пока ВсеКалендариСотрудников.Следующий() Цикл
		...
		ОсновнойКалендарьПользователя = ПользователиСтоматология.ПолучитьЗначениеПоУмолчаниюПользователя(ВсеКалендариСотрудников.Пользователь, "ОсновнойКалендарь");
...
// Функция - Получить календарь сотрудника
//
// Параметры:
//  Сотрудник	 - 	 - 
// 
...
//   - 
//
Функция ПолучитьКалендарьСотрудника(Сотрудник) Экспорт
