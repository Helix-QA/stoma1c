...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СпСтопБитыДО.Добавить(0, НСтр("ru='1 стоп-бит';en='1 stop-bit'"));
	СпСтопБитыДО.Добавить(1, НСтр("ru='1,5 стоп-бита';en='1,5 stop-bits'"));
	СпСтопБитыДО.Добавить(2, НСтр("ru='2 стоп-бита';en='2 stop-bits'"));
	...
	СпШиринаСлипЧека.Добавить(24,  НСтр("ru='24 сим.';en='24 sim.'"));
	СпШиринаСлипЧека.Добавить(32,  НСтр("ru='32 сим.';en='32 sim.'"));
	СпШиринаСлипЧека.Добавить(36,  НСтр("ru='36 сим.';en='36 sim.'"));
	СпШиринаСлипЧека.Добавить(40,  НСтр("ru='40 сим.';en='40 sim.'"));
	СпШиринаСлипЧека.Добавить(48,  НСтр("ru='48 сим.';en='48 sim.'"));
	...
	СтруктураМеню.Вставить("АвторизационныйКанал"	   , "АвторизационныйКанал");
	СтруктураМеню.Вставить("КаналУправления"  		   , "КаналУправления");	
	СтруктураМеню.Вставить("ДополнительноеОборудование", "ДополнительноеОборудование");	
...
Процедура ТестУстройства(Команда)
	...
	Иначе
		ДополнительноеОписание = ?(ТипЗнч(ВыходныеПараметры) = Тип("Массив")
		                           ...
		                           НСтр("ru='Дополнительное описание:';en='Additional description:'") + " " + ВыходныеПараметры[1],
		                           "");


		ТекстСообщения = НСтр("ru='Тест не пройден.%ПереводСтроки%%ДополнительноеОписание%';en='Test not passed.%ПереводСтроки%%ДополнительноеОписание%'");
