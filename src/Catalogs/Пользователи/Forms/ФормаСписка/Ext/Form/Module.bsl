...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Элементы.ЗавершитьИЗакрыть.Видимость = Ложь;
		Элементы.КнопкаВыбрать.Видимость     = Истина;
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Если ХранимыеПараметры.РасширенныйПодбор Тогда
				...
				Элементы.КнопкаВыбрать.Видимость = Ложь;
	...
	Иначе
		...
		Элементы.ГруппаКнопкаЗавершитьИЗакрыть.Видимость = Ложь; 
		Элементы.ГруппаКнопкаВыбрать.Видимость = Ложь;
...
Процедура УстановитьЗаголовокВыбранныхПользователейИГрупп()
	...
	Иначе
		...
		Элементы.ПользователиСписок.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
		Элементы.ПользователиСписок.Заголовок = НСтр("ru = 'Все пользователи'");
	КонецЕсли;
