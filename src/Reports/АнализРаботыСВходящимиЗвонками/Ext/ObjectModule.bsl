...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["АнализРаботыСВходящимиЗвонками"].Рекомендуемый    = Истина;
	НастройкиВариантов["АнализРаботыСВходящимиЗвонками"].Вставить("УровеньГруппировкиСтрок", 4);
