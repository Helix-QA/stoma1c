...
Функция ПоследовательностьОпераций(ДокументСсылка) Экспорт
	...
	Операция = ИнтеграцияМДЛП.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящее, Перечисления.ОперацииОбменаМДЛП.ПередачаДанных_УничтожениеЛП);
...
Функция ЗапросСтатусаОформления(ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияМДЛППереопределяемый.ЗапросСтатусаОформленияУведомленияОФактеУничтожения(ДокументОснование);
...
Процедура ПриЗаполненииДокументовПанелиМаркировкиМДЛП(ТаблицаДокументы) Экспорт
	...
	Описание = ИнтеграцияМДЛП.ДобавитьДокументНаПанельМаркировки(
		ТаблицаДокументы,
		Метаданные.Документы.УведомлениеОФактеУничтоженияМДЛП,
		НСтр("ru = 'Уничтожение'"),
...
Функция ПанельМаркировкиМДЛПТекстЗапросаОформите() Экспорт
	...
	Возврат ИнтеграцияМДЛППереопределяемый.УведомлениеОФактеУничтоженияТекстЗапросаОформите();
...
Функция ПанельМаркировкиМДЛПТекстЗапросаОтработайте() Экспорт
	...
	Возврат Обработки.ПанельМаркировкиМДЛП.ТекстЗапросаОтработайте(Метаданные.Документы.УведомлениеОФактеУничтоженияМДЛП);
...
Функция ПанельМаркировкиМДЛПТекстЗапросаОжидайте() Экспорт
	...
	Возврат Обработки.ПанельМаркировкиМДЛП.ТекстЗапросаОжидайте(Метаданные.Документы.УведомлениеОФактеУничтоженияМДЛП);
...
Функция СообщениеКПередаче(ДокументСсылка, ДальнейшееДействие, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат УведомлениеОФактеУничтожения(ДокументСсылка);
...
Функция ПредставлениеДокумента() Экспорт
	...
	ВозвращаемоеЗначение.КомандаСоздать                       = НСтр("ru = 'Создать уведомление об уничтожении МДЛП'");
	ВозвращаемоеЗначение.ИмяКомандыСоздать                    = "СоздатьУведомлениеОФактеУничтоженияМДЛП";
	ВозвращаемоеЗначение.ИмяКомандыОткрыть                    = "ОткрытьУведомлениеОФактеУничтоженияМДЛП";
	ВозвращаемоеЗначение.ДокументОтсутствуетНетПравНаСоздание = НСтр("ru = 'Уведомление об уничтожении МДЛП не создано'");
	ВозвращаемоеЗначение.Представление                        = НСтр("ru = 'Уведомление об уничтожении МДЛП: %1'");
	ВозвращаемоеЗначение.НесколькоДокументовПредставление     = НСтр("ru = 'Уведомление об уничтожении МДЛП (%1)'");
...
Функция УведомлениеОФактеУничтожения(ДокументСсылка)
	...
	СообщениеКПередаче.Операция = Перечисления.ОперацииОбменаМДЛП.ПередачаДанных_УничтожениеЛП;
	...
	|	Шапка.СпособУничтожения                КАК СпособУничтожения
	|ИЗ
	|	Документ.УведомлениеОФактеУничтоженияМДЛП КАК Шапка
	|ГДЕ
	|	Шапка.Ссылка = &Ссылка
	...
	|ИЗ
	|	Документ.УведомлениеОФактеУничтоженияМДЛП.Товары КАК Товары
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		Документ.УведомлениеОФактеУничтоженияМДЛП.НомераУпаковок КАК НомераУпаковок
	|	ПО
	...
	|ИЗ
	|	Документ.УведомлениеОФактеУничтоженияМДЛП.ТранспортныеУпаковки КАК НомераУпаковок
	|ГДЕ
	...
	ИнтеграцияМДЛП.ЗаполнитьСвойствоXDTO(Уведомление, "destruction_method", ИнтеграцияМДЛП.КодЗначенияПеречисления(Шапка.СпособУничтожения), СообщениеКПередаче);
