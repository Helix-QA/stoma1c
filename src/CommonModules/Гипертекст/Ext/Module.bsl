...
//
Функция ПолучитьАдресКартинкиHTML(Картинка) Экспорт
	
	ИдКартинки = ЗначениеВСтрокуВнутр(Картинка); 
	ИдКартинки = СтрРазделить(ИдКартинки, "{")[3];
	ИдКартинки = СтрРазделить(ИдКартинки, "}")[0];
	ИдКартинки = Прав(ИдКартинки, 36);	
	
	АдресКартинкиHTML = "v8config://v8cfgHelp/mdpicture/id" + ИдКартинки;

	Возврат АдресКартинкиHTML;
