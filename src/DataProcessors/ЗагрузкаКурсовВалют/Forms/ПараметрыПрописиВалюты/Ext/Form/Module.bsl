...
Функция ПараметрыПрописиНаРусском(Форма)
	...
	Возврат Форма.ПолеПрописи1наРусском + ", "
			...
			+ Форма.ПолеПрописи9наРусском + ", "
			+ Форма.ПолеПрописи10наРусском;
...
Процедура ПрочитатьПараметрыПрописи()
	...
	ПолеПрописи9наРусском  = СокрЛП(СтрПолучитьСтроку(СтрокаПараметров, 10));
	ПолеПрописи10наРусском = СокрЛП(СтрПолучитьСтроку(СтрокаПараметров, 11));
