...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Элементы.ГруппаКнопкиЗакрыть.ЦветФона          = Новый Цвет(25,116,206); 
		Элементы.Закрыть.ЦветТекста                    = Новый Цвет(255, 255, 255);
	Иначе
...
Процедура УстановитьОтображениеЭлементовФормы(Форма)
	...
	Если Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.ГруппаВыборРежимаОбновления Тогда
		...
		Элементы.ГруппаКнопкиЗакрыть.ЦветФона = Новый Цвет(242, 242, 242); 
		Элементы.Закрыть.ЦветТекста           = Новый Цвет(77, 77, 77);
...
Процедура УстановитьОтображениеИнформацииОбОшибке(
	...
	Если ОтображатьЖР Тогда
		ПредставлениеОшибки = СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
