...
Процедура ОтразитьПоступление(Отказ)
	...
	Если СостояниеПодтверждения = Перечисления.СостоянияПодтвержденияМДЛП.ПринятоГИСМ Тогда
		...
		|	ЗНАЧЕНИЕ(Перечисление.СтатусыУпаковокМДЛП.ВОбороте)  КАК Статус
		|ПОМЕСТИТЬ ПодтвержденныеУпаковки
		|ИЗ
		|	Документ.УведомлениеОПеремещенииГЛОМДЛП.НомераУпаковок КАК ПодтвержденныеУпаковки
		|ГДЕ
		...
		|	ЗНАЧЕНИЕ(Перечисление.СтатусыУпаковокМДЛП.ВОбороте)  КАК Статус
		|ИЗ
		|	Документ.УведомлениеОПеремещенииГЛОМДЛП.ТранспортныеУпаковки КАК ПодтвержденныеУпаковки
		|ГДЕ
		|	ПодтвержденныеУпаковки.Ссылка = &Ссылка
		|	И НЕ ПодтвержденныеУпаковки.Отклонено
		|;
		...
		|		ИЗ
		|			Документ.УведомлениеОПеремещенииГЛОМДЛП.НомераУпаковок КАК Т
		|		ГДЕ
		...
		|	ЛОЖЬ                                                  КАК ВложеныПотребительскиеУпаковки
		|ИЗ
		|	Документ.УведомлениеОПеремещенииГЛОМДЛП.ТранспортныеУпаковки КАК ТранспортныеУпаковки
		|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
		|		Документ.УведомлениеОПеремещенииГЛОМДЛП.СоставТранспортныхУпаковок КАК СоставТранспортныхУпаковок
		|	ПО
		...
		|	Документ.УведомлениеОПеремещенииГЛОМДЛП.ТранспортныеУпаковки КАК ТранспортныеУпаковки
		|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
		|		Документ.УведомлениеОПеремещенииГЛОМДЛП.ИерархияГрупповыхУпаковок КАК НомераУпаковок
		|	ПО
