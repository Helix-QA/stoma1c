...
Процедура ОбновитьОписаниеСвойствВидовДоступа(ЕстьИзменения = Неопределено, ТолькоПроверка = Ложь) Экспорт
	...
	Попытка
		...
		СтандартныеПодсистемыСервер.ОбновитьПараметрРаботыПрограммы("ПараметрыОграниченияДоступа",
			"СвойстваВидовДоступа", СвойстваВидовДоступа, ЕстьТекущиеИзменения, ТолькоПроверка, Параметры);
		
		Если Не ТолькоПроверка Тогда
			ЕстьИзмененияТиповГруппИЗначенийДоступа = ЕстьТекущиеИзменения
				И (Не Параметры.Свойство("СвойстваВидовДоступа")
				   Или ЕстьИзмененияТиповГруппИЗначенийДоступа(СвойстваВидовДоступа, Параметры.СвойстваВидовДоступа));
