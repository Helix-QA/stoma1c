...
//  СокращатьРазрядностьВерсии - Булево - разрешить сокращать версию 
//  (завершающуюся на 0000/000/00 или 9999/999/99) в следующих случаях:
//                    А.00.000.0000 = А,
//                    А.Б.000.0000 = А.Б,
//                    А.Б.В.0000 = А.Б.В,
//                    А.99.999.9999 = А.*,
...
//  Разделитель1           - Строка - разделитель значений 1 
//  (например, разделяет элементы массива или ключ и значение структуры или соответствия);
...
//  СокращатьПробелы      - Булево - Истина, если для каждой строки надо 
//  Предварительно удалять незначащие символы с концов строки.
//
// Возвращаемое значение:
