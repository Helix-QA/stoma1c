...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
 	...
 	СтруктураОписания = ПодключаемыеКомандыПереопределяемый.УниверсальнаяСтруктураОписанияОбъектовПодключаемыхКоманд();
	...
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Справочники.МедицинскиеКарты"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Справочники.Номенклатура"));
	
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.Прием"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.ВозвратОтПокупателя"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.ВозвратПоставщику"));
	СписокОбъектов.Добавить(ОбщегоНазначения.ОбщийМодуль("Документы.ЗаказПоставщику"));
