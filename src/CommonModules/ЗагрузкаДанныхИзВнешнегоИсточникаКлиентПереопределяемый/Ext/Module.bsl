...
Процедура ПриУстановкеОбщегоЗначения(Форма, НастройкиЗагрузкиДанных, ТаблицаСопоставленияДанных) Экспорт
	...
	ИначеЕсли НастройкиЗагрузкиДанных.ПолноеИмяОбъектаЗаполнения = "Справочник.Сотрудники" Тогда
		
		ИмяФормыВыбораГруппы = "Справочник.Сотрудники.ФормаВыбораГруппы";
...
Процедура ПриОбработаткеРезультатаВыбораОбщегоЗначения(Результат, ДополнительныеНастройки) Экспорт
	...
	Если ТаблицаСопоставленияДанных.Количество() > 0 
		...
		Если НастройкиЗагрузкиДанных.ПолноеИмяОбъектаЗаполнения = "Справочник.Контрагенты"
			ИЛИ НастройкиЗагрузкиДанных.ПолноеИмяОбъектаЗаполнения = "Справочник.Номенклатура"
			ИЛИ НастройкиЗагрузкиДанных.ПолноеИмяОбъектаЗаполнения = "Справочник.КонтактныеЛица"
			ИЛИ НастройкиЗагрузкиДанных.ПолноеИмяОбъектаЗаполнения = "Справочник.Сотрудники"
			Тогда
