...
Функция ПодключитьУстройство(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) Экспорт
	...
	ВыходныеПараметры.Добавить("HelixReaderGantner");
	...
	ОбъектДрайвера.ClientName   = "HelixReader";	
	ОбъектДрайвера.Device_1c    = СокрЛП(Параметры.Устройство);
	//ОбъектДрайвера.SetBiometrics(Параметры.Биометрия);
...
Функция ОбработатьСобытие(ОбъектДрайвера, Параметры, ПараметрыПодключения, Событие, Данные, ВыходныеПараметры) Экспорт
	...
	Результат = Истина;
	Если Параметры.Свойство("КонвертироватьВ16сс") и Параметры.КонвертироватьВ16сс Тогда
		Попытка
