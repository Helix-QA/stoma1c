...
Процедура ОбновитьДанныеРегистра(ГруппыДоступа = Неопределено,
	...
	ТекстЗапроса =
	"ВЫБРАТЬ
	|	НовыеДанные.Таблица КАК Таблица,
	|	НовыеДанные.ГруппаДоступа КАК ГруппаДоступа,
	|	НовыеДанные.Изменение КАК Изменение,
	|	НовыеДанные.Добавление КАК Добавление,
	|	НовыеДанные.ЧтениеБезОграничения КАК ЧтениеБезОграничения,
	|	НовыеДанные.ИзменениеБезОграничения КАК ИзменениеБезОграничения,
	|	НовыеДанные.ДобавлениеБезОграничения КАК ДобавлениеБезОграничения,
	|	НовыеДанные.ТипТаблицы КАК ТипТаблицы,
	|   НовыеДанные.Пользователь КАК Пользователь,
