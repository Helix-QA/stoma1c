...
Функция РазобратьШтриховойКодТовара(Знач Штрихкод, Знач ШтрихкодВBase64 = Ложь) Экспорт;
	#Если ВебКлиент Тогда
		...
		Возврат МенеджерОборудованияМаркировкаВызовСервера.РазобратьШтриховойКодТовара(Штрихкод, ШтрихкодВBase64);
	#Иначе
...
Функция РазобратьШтриховойКодТовараСлужебная(Знач Штрихкод, Знач ШтрихкодВBase64 = Ложь) Экспорт;
	...
	Иначе
		...
		ДанныеКодаТовара.ШтрихкодBase64 = МенеджерОборудованияВызовСервера.ШтрихкодВBase64(ШтриховойКодТовара);
	КонецЕсли;
