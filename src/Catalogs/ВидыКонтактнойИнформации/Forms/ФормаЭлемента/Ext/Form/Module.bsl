...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ЗапретРедактированияРеквизитовОбъектов") Тогда
			...
			МодульЗапретРедактированияРеквизитовОбъектов.ЗаблокироватьРеквизиты(ЭтотОбъект, Элементы.ГруппаКнопкиЗапретаРедактирования, НСтр("ru = 'Разрешить редактирование типа и группы'"));
			Для каждого КнопкиЗапретаРедактирования Из Элементы.ГруппаКнопкиЗапретаРедактирования.ПодчиненныеЭлементы Цикл
...
Процедура ИзменитьОтображениеПриИзмененииТипа()
	...
	Иначе
		...
		Если Объект.Тип = ПредопределенноеЗначение("Перечисление.ТипыКонтактнойИнформации.АдресЭлектроннойПочты") Тогда
			...
			Элементы.ВидРедактирования.Видимость = Истина;
			Элементы.ВидРедактирования.Доступность = Истина;
