...
Процедура ЗаписатьИЗакрытьВыполнить()
	...
	ПараметрыОборудования.Вставить("IPПорт", IPПорт);
	...
	ПараметрыОборудования.Вставить("ТаблицаВыгрузки", ТаблицаВыгрузки);
	ПараметрыОборудования.Вставить("ТаблицаЗагрузки", ТаблицаЗагрузки);
	ПараметрыОборудования.Вставить("Разделитель", Разделитель);
	ПараметрыОборудования.Вставить("Модель", Модель);
	ПараметрыОборудования.Вставить("Наименование", Наименование);
	...
	КонецЦикла;
    ПараметрыОборудования.Вставить("ФорматВыгрузки", времФорматВыгрузки);
	...
	КонецЦикла;
	ПараметрыОборудования.Вставить("ФорматЗагрузки", времФорматЗагрузки); 
