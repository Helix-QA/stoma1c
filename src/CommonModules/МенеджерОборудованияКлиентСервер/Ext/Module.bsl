...
// 
// Параметры:
//  ПланируемыйСтатусМаркируемогоТовара - ПеречислениеСсылка
//  .ПланируемыйСтатусМаркируемогоТовара - Планируемый статус маркируемого товара.  
// 
// Возвращаемое значение:
...
Функция КодПланируемыйСтатусМаркируемогоТовара(ПланируемыйСтатусМаркируемогоТовара) Экспорт
	...
	Возврат 0; // Соответствие.Получить(ПланируемыйСтатусМаркируемогоТовара);
...
Функция КодОтветаОИСМОСтатусеТовара(ОтветОИСМОСтатусеТовара) Экспорт
	...
	Возврат 0; // Соответствие.Получить(ОтветОИСМОСтатусеТовара);
...
Функция ОтветОИСМОСтатусеТовараПоКоду(ОтветОИСМОСтатусеТовара) Экспорт
	...
	Возврат Неопределено; // Соответствие.Получить(Число(ОтветОИСМОСтатусеТовара));
...
Функция КодВидДокументаУдостоверяющегоЛичность(ВидДокументаУдостоверяющегоЛичность) Экспорт
	...
	// 0 - Неопределено
	Возврат 0; // ВидДокумента.Получить(ВидДокументаУдостоверяющегоЛичность);
...
Функция ВидДокументаУдостоверяющегоЛичностьПоКоду(КодВидаДокументаУдостоверяющегоЛичность) Экспорт
	...
	Возврат Неопределено; // ВидДокумента.Получить(КодВидаДокументаУдостоверяющегоЛичность);
...
Функция КодМерыКоличестваПредметаРасчетаККТ(МераКоличестваПредметаРасчетаККТ) Экспорт
	...
	Возврат 0; // МерыКоличества.Получить(МераКоличестваПредметаРасчетаККТ);
...
Функция МераКоличестваПредметаРасчетаККТПоКоду(КодМерыКоличестваПредметаРасчетаККТ) Экспорт
	...
	Возврат Неопределено; // МерыКоличества.Получить(КодМерыКоличестваПредметаРасчетаККТ);
...
Функция МераКоличестваПредметаРасчетаПоКодуЕдиницыИзмерения(КодЕдиницыИзмерения) Экспорт
	...
	Возврат Неопределено; // МерыКоличества;
...
Функция ПараметрыФискальнойСтрокиЧека() Экспорт;
	...
	ПараметрыСтроки.Вставить("СуммаВключаетНДС", Истина);  
...
Функция ПараметрыФискализацииЧека() Экспорт
	...
	ПараметрыФискализации.Вставить("ДокументОснование", Новый Массив());
	...
	ПараметрыФискализации.Вставить("КорректируемыйДокумент"	, Новый Массив());
	ПараметрыФискализации.Вставить("НеприменениеККТ"		, Ложь); 
	ПараметрыФискализации.Вставить("ДанныеКоррекции"		, ПараметрыДанныеКоррекции()); 
