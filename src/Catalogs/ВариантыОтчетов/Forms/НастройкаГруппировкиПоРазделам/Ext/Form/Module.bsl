...
Процедура ПреместитьВариант(Команда)
     ...
     ОткрытьФорму("Справочник.ВариантыОтчетов.Форма.ПереместитьВариантВРаздел",,,,,, Новый ОписаниеОповещения("ПреместитьВариантЗавершение", ЭтаФорма), РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);	
...
Процедура СкопироватьВариант(Команда)
	...
	ОткрытьФорму("Справочник.ВариантыОтчетов.Форма.СкопироватьВариантВРаздел",,,,,, Новый ОписаниеОповещения("СкопироватьВариантЗавершение", ЭтаФорма), РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);	
...
// Процедура - Преместить вариант завершение
// Завершение немодального открытия окна формы - Справочник Варианты отчетов - ПереместитьВариантВРаздел
// Параметры:
//  Результат	 - 	 Результат Оповещения 
//  Параметры	 - 	 Параметры Оповещения
//
&НаКлиенте
Процедура ПреместитьВариантЗавершение(Результат, Параметры)  Экспорт
...
// Процедура - Скопировать вариант завершение
// Завершение немодального открытия окна формы - Справочник Варианты отчетов - СкопироватьВариантВРаздел
// Параметры:
//  Результат	 - 	 Результат Оповещения 
//  Параметры	 - 	 Параметры Оповещения
//
&НаКлиенте
Процедура СкопироватьВариантЗавершение(Результат, Параметры)  Экспорт
