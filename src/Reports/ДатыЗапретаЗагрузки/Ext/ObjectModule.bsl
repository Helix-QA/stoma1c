...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ДатыЗапретаЗагрузкиПоИнформационнымБазам"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ДатыЗапретаЗагрузкиПоИнформационнымБазамБезРазделов"].Рекомендуемый    = Ложь;	
	НастройкиВариантов["ДатыЗапретаЗагрузкиПоИнформационнымБазамБезОбъектов"].Рекомендуемый    = Ложь;	
	НастройкиВариантов["ДатыЗапретаЗагрузкиПоРазделамОбъектамДляИнформационныхБаз"].Рекомендуемый = Ложь;	
	НастройкиВариантов["ДатыЗапретаЗагрузкиПоОбъектамДляИнформационныхБаз"].Рекомендуемый    = Ложь;	
	НастройкиВариантов["ДатыЗапретаЗагрузкиПоРазделамДляИнформационныхБаз"].Рекомендуемый    = Ложь;	
