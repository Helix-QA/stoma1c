...
Процедура ГрафикРаботыВыбор(Элемент, ВыбраннаяДата)
	...
	Если ДниГрафика.Получить(ВыбраннаяДата) = Неопределено Тогда
		...
		ВставитьВФиксированноеСоответствие(ДниГрафика, ВыбраннаяДата, Истина);
	...
	Иначе
		...
		УдалитьИзФиксированногоСоответствия(ДниГрафика, ВыбраннаяДата);
...
//
Процедура ВставитьВФиксированноеСоответствие(ФиксированноеСоответствие, Ключ, Значение)
...
//
Процедура УдалитьИзФиксированногоСоответствия(ФиксированноеСоответствие, Ключ)
