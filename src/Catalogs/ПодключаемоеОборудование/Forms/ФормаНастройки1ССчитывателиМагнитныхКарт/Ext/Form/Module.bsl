...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(ПараметрыОборудования) = Тип("Структура") Тогда 
        ...
        времПараметрыДорожек = ?(ПараметрыОборудования.Свойство("ПараметрыДорожек")	, ПараметрыОборудования.ПараметрыДорожек	, Неопределено); 
	...
	Если времПараметрыДорожек = Неопределено Тогда
	...
	Если Не времПараметрыДорожек = Неопределено Тогда
