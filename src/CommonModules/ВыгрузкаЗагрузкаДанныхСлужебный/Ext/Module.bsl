...
//
// Параметры:
//	ДанныеФайла - Строка - имя файла архива или его идентификатор.
...
Функция ЗагрузитьДанныеТекущейОбластиИзАрхива(Знач ДанныеФайла, Знач ПараметрыЗагрузки) Экспорт
	...
	Иначе
		ЕстьУстановленныеРасширения = ЕстьУстановленныеРасширенияИзменяющиеСтруктуруДанных();	
	КонецЕсли;
...
Функция НачатьЗагрузкуДанныхТекущейОбластиИзАрхива(Знач ДанныеФайла, Знач ПараметрыЗагрузки, 
	...
	ПроверятьВерсиюКонфигурации = Неопределено;
	Если Не ПараметрыЗагрузки.Свойство("ПроверятьВерсиюКонфигурации", ПроверятьВерсиюКонфигурации) Тогда
		ПроверятьВерсиюКонфигурации = Истина;
	КонецЕсли;
		
	Если ПроверятьВерсиюКонфигурации И Не ВыгрузкаВАрхивеСовместимаСТекущейВерсиейКонфигурации(ИнформацияОВыгрузке) Тогда
...
Функция ЕстьУстановленныеРасширенияИзменяющиеСтруктуруДанных()
...
Процедура ВыгрузитьСхемуКонфигурации(Контейнер, ПараметрыВыгрузки)
	...
	Если Не ПараметрыВыгрузки.Свойство("ДанныеСхемыКонфигурации", ДанныеСхемыКонфигурации) Тогда
		ДанныеСхемыКонфигурации = СхемаКонфигурации.ДвоичныеДанныеСхемы(Истина, Ложь);	
	КонецЕсли;
