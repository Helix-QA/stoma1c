...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ФорматТН = 0 ИЛИ ФорматТН = 4 Тогда
		КодСтраны = "+7";
	ИначеЕсли ФорматТН = 1 Тогда
		КодСтраны = "8";
	Иначе
...
Функция КонтактнаяИнформацияПоЗначениюРеквизитов()
	...
	Если КодСтраны = "8" И СтрНайти(Результат.value, "+")Тогда
		Результат.value = СтрЗаменить(Результат.value, "+", "");
	КонецЕсли;
...
Процедура ЗаполнитьПредставлениеТелефонаСейчас()
	...
	Если КодСтраны = "8" И СтрНайти(Представление, "+")Тогда
