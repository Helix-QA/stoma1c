...
&НаКлиенте
Перем КлиентскиеПараметры Экспорт;   // Клиентские параметры

&НаКлиенте
Перем ОписаниеДанных, ФормаОбъекта, ТекущийСписокПредставлений;   // Описание данных, Форма объекта, Текущий список представлений

&НаКлиенте
Перем ОтображениеДанныхОбновлено;    // Отображение данных обновлено
