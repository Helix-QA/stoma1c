...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["Прибыль"].Рекомендуемый                   = Истина;
	НастройкиВариантов["Прибыль по сотрудникам"].Рекомендуемый    = Ложь;
	НастройкиВариантов["Прибыль по клиентам"].Рекомендуемый   	  = Ложь;
