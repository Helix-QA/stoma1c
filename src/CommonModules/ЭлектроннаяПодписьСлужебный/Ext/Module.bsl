...
//		"Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования.Макет.КомпонентаXMLDSig");
	...
	ОписаниеКомпоненты.Вставить("ИмяОбъекта", "ExtraCryptoAPI");
	ОписаниеКомпоненты.Вставить("ПолноеИмяМакета",
		"Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования.Макет.КомпонентаExtraCryptoAPI_3_0_1_27");
