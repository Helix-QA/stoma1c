			...
			Если ЗначениеЗаполнено(РасшифровкаПлатежа[А].ДокументОснования)  Тогда		
				Если ТипЗнч(РасшифровкаПлатежа[А].ДокументОснования) = Тип("ДокументСсылка.Прием")
					...
					Если ОбщегоНазначенияСтоматология.ЕстьРеквизитДокумента("СуммаОплачено", ДокументОбъект.Метаданные()) Тогда
						...
						ИначеЕсли ТипЗнч(РасшифровкаПлатежа[А].ДокументОснования) = Тип("ДокументСсылка.ВозвратОтПокупателя") И ЗначениеЗаполнено(РасшифровкаПлатежа[А].ДокументОснования.ДокументОснования) Тогда
							
							НеУчитыватьДвижения = ?(УдалениеПроведения, ДокументОплаты.Ссылка, Неопределено);
							СуммаОплаченоПоДокументу = РегистрыНакопления.ВзаиморасчетыСКонтрагентами.ПолучитьСуммуОплатПоДокументуВозврата(ДокументОснования, НеУчитыватьДвижения);							
