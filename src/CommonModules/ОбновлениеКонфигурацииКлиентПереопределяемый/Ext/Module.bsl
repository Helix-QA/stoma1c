...
// Устарела. Следует использовать ПриПроверкеГотовностиКОбновлениюКонфигурации.
//
...
// Устарела. Следует использовать ПриОпределенииАдресаСтраницыПолученияДоступаКСайтуОбновлений.
//
...
// Устарела. Следует использовать ПриПроверкеОбновленияДляСледующейРедакцииПлатформы.
// 
...
// Устарела. Следует использовать ПриПроверкеИспользованияПоверкиЛегальностиСкачиванияОбновлений.
//
