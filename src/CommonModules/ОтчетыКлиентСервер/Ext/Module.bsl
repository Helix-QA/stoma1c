...
Функция НастройкиОтчетаПоУмолчанию() Экспорт
	...
	ПараметрыПечатиПоУмолчанию = Новый Структура;
	ПараметрыПечатиПоУмолчанию.Вставить("ПолеСверху", 10);
	ПараметрыПечатиПоУмолчанию.Вставить("ПолеСлева", 10);
	ПараметрыПечатиПоУмолчанию.Вставить("ПолеСнизу", 10);
	ПараметрыПечатиПоУмолчанию.Вставить("ПолеСправа", 10);
	ПараметрыПечатиПоУмолчанию.Вставить("ОриентацияСтраницы", ОриентацияСтраницы.Портрет);
	ПараметрыПечатиПоУмолчанию.Вставить("АвтоМасштаб", Истина);
	ПараметрыПечатиПоУмолчанию.Вставить("МасштабПечати", Неопределено);
...
// Функция - Индекс элемента настройки по пути
//
// Параметры:
//  Путь			 - 	 - 
//  СвойствоЭлемента - 	 - 
...
#Область ______________УСТАРЕВШИЕ________________
