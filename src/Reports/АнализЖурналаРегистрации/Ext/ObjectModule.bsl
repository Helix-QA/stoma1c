...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИначеЕсли ВариантОтчета = "АнализАктивностиПользователей" Тогда
		...
		Если ТипЗнч(ПользователиИГруппы) = Тип("СправочникСсылка.Сотрудники") Тогда
...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["АнализАктивностиПользователей"].Рекомендуемый    = Истина;	
	НастройкиВариантов["АнализАктивностиПользователей"].ИмяМакетаОбразца = "ОбразецАнализАктивностиПользователей";
	
	НастройкиВариантов["АктивностьПользователя"].Рекомендуемый    = Истина;	
	НастройкиВариантов["АктивностьПользователя"].ИмяМакетаОбразца = "ОбразецАктивностьПользователя";
	
	НастройкиВариантов["КонтрольЖурналаРегистрации"].Рекомендуемый    = Истина;	
	НастройкиВариантов["КонтрольЖурналаРегистрации"].ИмяМакетаОбразца = "ОбразецКонтрольЖурналаРегистрации";
	
	НастройкиВариантов["ПродолжительностьРаботыРегламентныхЗаданий"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ПродолжительностьРаботыРегламентныхЗаданий"].ИмяМакетаОбразца = "ОбразецПродолжительностьРаботыРегламентныхЗаданий";
	

КонецПроцедуры

// Функция - Параметры отчета активность пользователя
//
// Параметры:
//  НастройкиОтчета	 - 	 - 
// 
...
// Процедура - Продолжительность работы регламентных заданий
//
// Параметры:
//  НастройкиОтчета		 - 	 - 
//  ДокументРезультат	 - 	 - 
