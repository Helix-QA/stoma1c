...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ЗагруженностьСтоматологии"].Рекомендуемый = Истина;		
	НастройкиВариантов["ПоЧасам"].Рекомендуемый    = Ложь;
	НастройкиВариантов["ПоДням"].Рекомендуемый     = Ложь;
	НастройкиВариантов["ПоМесяцам"].Рекомендуемый  = Ложь;
