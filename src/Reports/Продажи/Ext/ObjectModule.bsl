...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["Продажи"].Рекомендуемый             	 = Истина;
	НастройкиВариантов["ПродажиПоКлиентам"].Рекомендуемый   	 = Ложь;
	НастройкиВариантов["ПродажиПоСотрудникам"].Рекомендуемый     = Ложь;
