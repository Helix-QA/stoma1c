...
//
//  Параметры:
//      ПорядковыйНомерПерехода             - Число  - Порядковый номер перехода, соответствует текущему шагу перехода.
//      ИмяОсновнойСтраницы                 - Строка - Имя страницы панели "ПанельОсновная",
//														соответствует текущему номеру перехода.
...
//														соответствует текущему номеру перехода.
//      ИмяОбработчикаПриОткрытии           - Строка - Имя функции-обработчика события открытия 
//														текущей страницы помощника.
//      ИмяОбработчикаПриПереходеДалее      - Строка - Имя функции-обработчика события перехода 
//														на следующую страницу помощника.
//      ИмяОбработчикаПриПереходеНазад      - Строка - Имя функции-обработчика события перехода
//														на предыдущую страницу помощника.
//      ДлительнаяОперация                  - Булево - Признак отображения страницы длительной операции.
//														Ложь - отображается обычная страница.
