...
Функция ЗаполнитьДополнительныеПараметры()
	...
	ОставлятьКопииСообщенийЧислоДней = ?(ОставлятьКопииСообщенийНаСервере,
	                                     ОставлятьКопииСообщенийЧислоДней,
	                                     0);
...
// Подготавливает форму к использованию - заполняет всевозможные
// списки выбора, устаенавливает доступность элементов, значения 
// по умолчанию. Не заполняет реквизиты формы по переданным параметрам.
//
&НаСервере
