			...
			Для Каждого СтрокаФормата Из Параметры.ФорматЗагрузки Цикл
				...
				ИначеЕсли СтрокаФормата.Наименование = "Количество" Тогда
					...
					Исключение 
						ВыходныеПараметры.Очистить();
						ВыходныеПараметры.Добавить(999);
						ВыходныеПараметры.Добавить(НСтр("ru='Ошибка при загрузке поля ""Количество"".';en='Mistake with loading fields ""Amount"".'"));
						Результат = Ложь;
					КонецПопытки;
				КонецЕсли;
			КонецЦикла;
...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ВыходныеПараметры.Добавить(?(Результат, "", НСтр("ru='Ошибка при подключении устройства';en='Mistake with connecting devices'")));
