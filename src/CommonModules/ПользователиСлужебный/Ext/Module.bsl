...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	// Хеликс
	Обработчики.Вставить("ТекущийСотрудник"			,  "ПользователиСлужебный.УстановкаПараметровСеанса");
...
Процедура УстановкаПараметровСеанса(Знач ИмяПараметра, УстановленныеПараметры) Экспорт
	...
	Если ИмяПараметра <> "ТекущийПользователь" И ИмяПараметра <> "ТекущийСотрудник" // Хеликс
	...
	ПараметрыСеанса.ТекущийСотрудник        	= ?(ЗначениеЗаполнено(Значения.ТекущийПользователь), Значения.ТекущийПользователь.Сотрудник, Справочники.Сотрудники.ПустаяСсылка());
	...
	УстановленныеПараметры.Добавить("ТекущийСотрудник");
...
Процедура НачатьОбработкуПользователяИБ(ПользовательОбъект,
	...
	Если НЕ ДополнительныеСвойства.Свойство("ОписаниеПользователяИБ") Тогда
		Если УровеньДоступа.УправлениеСписком
			...
			Если Не ПользовательОбъект.Наименование = "Служебный пользователь API (не удалять!)" Тогда
