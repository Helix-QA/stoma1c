...
// 
Функция ВернутьСловоСклоненноеПоЧислу(Слово, Число, Падеж = "", УкраинскийЯзык = Ложь, ИспользуетсяНаречие = Ложь) Экспорт
	
	Если ПользователиСлужебныйВызовСервераПовтИсп.ЯзыкИнтерфейсаАнглийский() Тогда
		Возврат ВернутьСловоСклоненноеПоЧислуАнглийский(Слово, Число);
	ИначеЕсли УкраинскийЯзык Тогда
		Возврат ВернутьСловоСклоненноеПоЧислуУкраинский(Слово, Число, Падеж);
	КонецЕсли;	
	...
	Если Слово = "День" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "дня");
			СоответствиеПоЧислам.Вставить(2, "дней");
			СоответствиеПоЧислам.Вставить(5, "дней");
		Иначе 	
			СоответствиеПоЧислам.Вставить(1, "день");
			СоответствиеПоЧислам.Вставить(2, "дня");         
			СоответствиеПоЧислам.Вставить(5, "дней");
		КонецЕсли;
	ИначеЕсли Слово = "Неделя" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "неделю");
			СоответствиеПоЧислам.Вставить(2, "недели");
			СоответствиеПоЧислам.Вставить(5, "недель");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "неделя");
			СоответствиеПоЧислам.Вставить(2, "недели");
			СоответствиеПоЧислам.Вставить(5, "недель");
		КонецЕсли;		
	ИначеЕсли Слово = "Месяц" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "месяца");
			СоответствиеПоЧислам.Вставить(2, "месяцев");
			СоответствиеПоЧислам.Вставить(5, "месяцев");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "месяц");
			СоответствиеПоЧислам.Вставить(2, "месяца");
			СоответствиеПоЧислам.Вставить(5, "месяцев");
		КонецЕсли;
	ИначеЕсли Слово = "Год" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "года");
			СоответствиеПоЧислам.Вставить(2, "лет");
			СоответствиеПоЧислам.Вставить(5, "лет");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "год");
			СоответствиеПоЧислам.Вставить(2, "года");
			СоответствиеПоЧислам.Вставить(5, "лет");
		КонецЕсли;
	ИначеЕсли Слово = "Клиент" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "клиента");
			СоответствиеПоЧислам.Вставить(2, "клиентов");
			СоответствиеПоЧислам.Вставить(5, "клиентов");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "клиент");
			СоответствиеПоЧислам.Вставить(2, "клиента");
			СоответствиеПоЧислам.Вставить(5, "клиентов");
		КонецЕсли;
	ИначеЕсли Слово = "Заморозка" Тогда
		СоответствиеПоЧислам.Вставить(1, "заморозка");
		СоответствиеПоЧислам.Вставить(2, "заморозки");
		СоответствиеПоЧислам.Вставить(5, "заморозок");
	ИначеЕсли Слово = "Услуга" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "услуги");
			СоответствиеПоЧислам.Вставить(2, "услуг");
			СоответствиеПоЧислам.Вставить(5, "услуг");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "услуга");
			СоответствиеПоЧислам.Вставить(2, "услуги");
			СоответствиеПоЧислам.Вставить(5, "услуг");
		КонецЕсли;
	ИначеЕсли Слово = "Часов" ИЛИ Слово = "Час" Тогда
		Если ИспользуетсяНаречие Тогда 
			СоответствиеПоЧислам.Вставить(1, "часа");
			СоответствиеПоЧислам.Вставить(2, "часов");
			СоответствиеПоЧислам.Вставить(5, "часов");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "час");
			СоответствиеПоЧислам.Вставить(2, "часа");
			СоответствиеПоЧислам.Вставить(5, "часов");
		КонецЕсли;
	ИначеЕсли Слово = "Минут" ИЛИ Слово = "Минута" Тогда
		Если ИспользуетсяНаречие Тогда 
			СоответствиеПоЧислам.Вставить(1, "минуты");
			СоответствиеПоЧислам.Вставить(2, "минут");
			СоответствиеПоЧислам.Вставить(5, "минут");
		Иначе 	
			Если Падеж = "Родительный" Тогда 
				СоответствиеПоЧислам.Вставить(1, "минуту");
				СоответствиеПоЧислам.Вставить(2, "минуты");
				СоответствиеПоЧислам.Вставить(5, "минут");
			Иначе 			
				СоответствиеПоЧислам.Вставить(1, "минута");
				СоответствиеПоЧислам.Вставить(2, "минуты");
				СоответствиеПоЧислам.Вставить(5, "минут");
			КонецЕсли;
		КонецЕсли;
	ИначеЕсли Слово = "Секунд" Тогда
		СоответствиеПоЧислам.Вставить(1, "секунда");
		СоответствиеПоЧислам.Вставить(2, "секунды");
		СоответствиеПоЧислам.Вставить(5, "секунд");				
	ИначеЕсли Слово = "Раз" Тогда
		СоответствиеПоЧислам.Вставить(1, "раз");
		СоответствиеПоЧислам.Вставить(2, "раза");
		СоответствиеПоЧислам.Вставить(5, "раз");
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "раза");
			СоответствиеПоЧислам.Вставить(2, "раз");
			СоответствиеПоЧислам.Вставить(5, "раз");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "раз");
			СоответствиеПоЧислам.Вставить(2, "раза");
			СоответствиеПоЧислам.Вставить(5, "раз");
		КонецЕсли;
	ИначеЕсли Слово = "Занятие" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "занятия");
			СоответствиеПоЧислам.Вставить(2, "занятий");
			СоответствиеПоЧислам.Вставить(5, "занятий");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "занятие");
			СоответствиеПоЧислам.Вставить(2, "занятия");
			СоответствиеПоЧислам.Вставить(5, "занятий");
		КонецЕсли;
	ИначеЕсли Слово = "Посещение" Тогда
		СоответствиеПоЧислам.Вставить(1, "посещение");
		СоответствиеПоЧислам.Вставить(2, "посещения");
		СоответствиеПоЧислам.Вставить(5, "посещений");
	ИначеЕсли Слово = "Перенос" Тогда 
		СоответствиеПоЧислам.Вставить(1, "перенос");
		СоответствиеПоЧислам.Вставить(2, "переноса");
		СоответствиеПоЧислам.Вставить(5, "переносов");
	ИначеЕсли Слово = "Пропущенный" Тогда 
		СоответствиеПоЧислам.Вставить(1, "пропущенный");
		СоответствиеПоЧислам.Вставить(2, "пропущенных");
		СоответствиеПоЧислам.Вставить(5, "пропущенных");
	ИначеЕсли Слово = "Просроченная" Тогда 
		СоответствиеПоЧислам.Вставить(1, "просроченная");
		СоответствиеПоЧислам.Вставить(2, "просроченные");
		СоответствиеПоЧислам.Вставить(5, "просроченных");		
	ИначеЕсли Слово = "Звонок" Тогда 
		СоответствиеПоЧислам.Вставить(1, "звонок");
		СоответствиеПоЧислам.Вставить(2, "звонка");
		СоответствиеПоЧислам.Вставить(5, "звонков");
	ИначеЕсли Слово = "Задача" Тогда 
		СоответствиеПоЧислам.Вставить(1, "задача");
		СоответствиеПоЧислам.Вставить(2, "задачи");
		СоответствиеПоЧислам.Вставить(5, "задач");
	ИначеЕсли Слово = "Сделка" Тогда 
		СоответствиеПоЧислам.Вставить(1, "сделка");
		СоответствиеПоЧислам.Вставить(2, "сделки");
		СоответствиеПоЧислам.Вставить(5, "сделок"); 
		// справочнику воронки возвращен синоним "сделки" по тикету 295690
	//ИначеЕсли Слово = "Воронка" Тогда 
	//	СоответствиеПоЧислам.Вставить(1, "воронка");
	//	СоответствиеПоЧислам.Вставить(2, "воронки");
	//	СоответствиеПоЧислам.Вставить(5, "воронок");		
	ИначеЕсли Слово = "Новая" Тогда 
		СоответствиеПоЧислам.Вставить(1, "новая");
		СоответствиеПоЧислам.Вставить(2, "новые");
		СоответствиеПоЧислам.Вставить(5, "новых");
	ИначеЕсли Слово = "Обработанная" Тогда 
		СоответствиеПоЧислам.Вставить(1, "обработанная");
		СоответствиеПоЧислам.Вставить(2, "обработанные");
		СоответствиеПоЧислам.Вставить(5, "обработанных");
	ИначеЕсли Слово = "Ожидает" Тогда 
		СоответствиеПоЧислам.Вставить(1, "ожидает");
		СоответствиеПоЧислам.Вставить(2, "ожидают");
		СоответствиеПоЧислам.Вставить(5, "ожидают");			
	ИначеЕсли Слово = "Получатель" Тогда
		Возврат СтрокаСЧислом(";получатель;;получателя;получателей;получателя", Число, ВидЧисловогоЗначения.Количественное, "L=ru");
	ИначеЕсли Слово = "Символ" Тогда
		Возврат СтрокаСЧислом(";символ;;символа;символов;символа", Число, ВидЧисловогоЗначения.Количественное, "L=ru");
	КонецЕсли;
...
// Функция, возвращает текстовое представления графикаработы салона
//
Функция ВернутьСловоСклоненноеПоЧислуАнглийский(Слово, Число) Экспорт
	
	РезультатСлово = "";
	
	Если Слово = "День" Тогда
		РезультатСлово = СтрокаСЧислом(";day;;;;days", Число, ВидЧисловогоЗначения.Количественное, "L=en");  
	ИначеЕсли Слово = "Неделя" Тогда
		РезультатСлово = СтрокаСЧислом(";week;;;;weeks", Число, ВидЧисловогоЗначения.Количественное, "L=en");		
	ИначеЕсли Слово = "Месяц" Тогда
		РезультатСлово = СтрокаСЧислом(";month;;;;months", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Год" Тогда
		РезультатСлово = СтрокаСЧислом(";year;;;;years", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Клиент" Тогда
		РезультатСлово = СтрокаСЧислом(";client;;;;clients", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Заморозка" Тогда
		РезультатСлово = СтрокаСЧислом(";freeze;;;;freezes", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Услуга" Тогда
		РезультатСлово = СтрокаСЧислом(";service;;;;services", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Часов" ИЛИ Слово = "Час" Тогда
		РезультатСлово = СтрокаСЧислом(";hour;;;;hours", Число, ВидЧисловогоЗначения.Количественное, "L=en");			
	ИначеЕсли Слово = "Минут" ИЛИ Слово = "Минута" Тогда
		РезультатСлово = СтрокаСЧислом(";minute;;;;minutes", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Секунд" Тогда
		РезультатСлово = СтрокаСЧислом(";second;;;;seconds", Число, ВидЧисловогоЗначения.Количественное, "L=en");				
	ИначеЕсли Слово = "Раз" Тогда
		РезультатСлово = СтрокаСЧислом(";time;;;;times", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Занятие" Тогда
		РезультатСлово = СтрокаСЧислом(";class;;;;classes", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Посещение" Тогда
		РезультатСлово = СтрокаСЧислом(";visit;;;;visits", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Перенос" Тогда 
		РезультатСлово = СтрокаСЧислом(";carry;;;;carries", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Пропущенный" Тогда 
		РезультатСлово = СтрокаСЧислом(";missed;;;;missed", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Просроченная" Тогда 
		РезультатСлово = СтрокаСЧислом(";overdued;;;;overdued", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Звонок" Тогда 
		РезультатСлово = СтрокаСЧислом(";call;;;;calls", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Задача" Тогда 
		РезультатСлово = СтрокаСЧислом(";task;;;;tasks", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Сделка" Тогда 
		РезультатСлово = СтрокаСЧислом(";deal;;;;deals", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Новая" Тогда 
		РезультатСлово = СтрокаСЧислом(";new;;;;new", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Обработанная" Тогда 
		РезультатСлово = СтрокаСЧислом(";processed;;;;processed", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	ИначеЕсли Слово = "Ожидает" Тогда 
		РезультатСлово = СтрокаСЧислом(";waiting;;;;waiting", Число, ВидЧисловогоЗначения.Количественное, "L=en");
	КонецЕсли;
	
	Возврат РезультатСлово;
	
КонецФункции	

// Функция, возвращает текстовое представления графика работы салона.
//
Функция ВернутьСловоСклоненноеПоЧислуУкраинский(Слово, Число, Падеж = "") Экспорт
	...
	Если Слово = "День" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "дня");
			СоответствиеПоЧислам.Вставить(2, "днів");
			СоответствиеПоЧислам.Вставить(5, "днів");
		Иначе 	
			СоответствиеПоЧислам.Вставить(1, "день");
			СоответствиеПоЧислам.Вставить(2, "дня");         
			СоответствиеПоЧислам.Вставить(5, "днів");
	...
	ИначеЕсли Слово = "Неделя" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "тиждень");
			СоответствиеПоЧислам.Вставить(2, "тижні");
			СоответствиеПоЧислам.Вставить(5, "тижнів");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "тиждень");
			СоответствиеПоЧислам.Вставить(2, "тижні");
			СоответствиеПоЧислам.Вставить(5, "тижнів");
	...
	ИначеЕсли Слово = "Месяц" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "місяця");
			СоответствиеПоЧислам.Вставить(2, "місяців");
			СоответствиеПоЧислам.Вставить(5, "місяців");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "місяць");
			СоответствиеПоЧислам.Вставить(2, "місяці");
			СоответствиеПоЧислам.Вставить(5, "місяців");
		КонецЕсли;
	ИначеЕсли Слово = "Год" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "року");
			СоответствиеПоЧислам.Вставить(2, "років");
			СоответствиеПоЧислам.Вставить(5, "років");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "год");
			СоответствиеПоЧислам.Вставить(2, "року");
			СоответствиеПоЧислам.Вставить(5, "років");
		КонецЕсли;
	ИначеЕсли Слово = "Клиент" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "клієнта");
			СоответствиеПоЧислам.Вставить(2, "клієнтів");
			СоответствиеПоЧислам.Вставить(5, "клієнтів");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "клієнт");
			СоответствиеПоЧислам.Вставить(2, "клієнта");
			СоответствиеПоЧислам.Вставить(5, "клієнтів");
		КонецЕсли;
	ИначеЕсли Слово = "Заморозка" Тогда
		СоответствиеПоЧислам.Вставить(1, "заморозка");
	...
	ИначеЕсли Слово = "Услуга" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "послуги");
			СоответствиеПоЧислам.Вставить(2, "послуг");
			СоответствиеПоЧислам.Вставить(5, "послуг");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "послуга");
			СоответствиеПоЧислам.Вставить(2, "послуги");
			СоответствиеПоЧислам.Вставить(5, "послуг");
		КонецЕсли;
	ИначеЕсли Слово = "Часов" ИЛИ Слово = "Час" Тогда
		СоответствиеПоЧислам.Вставить(1, "година");
		СоответствиеПоЧислам.Вставить(2, "години");
		СоответствиеПоЧислам.Вставить(5, "годин");				
	ИначеЕсли Слово = "Минут" ИЛИ Слово = "Минута" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "хвилину");
			СоответствиеПоЧислам.Вставить(2, "хвилини");
			СоответствиеПоЧислам.Вставить(5, "хвилин");
		Иначе 			
			СоответствиеПоЧислам.Вставить(1, "хвилина");
			СоответствиеПоЧислам.Вставить(2, "хвилини");
			СоответствиеПоЧислам.Вставить(5, "хвилин");
		КонецЕсли;
	ИначеЕсли Слово = "Секунд" Тогда
		СоответствиеПоЧислам.Вставить(1, "секунда");
		СоответствиеПоЧислам.Вставить(2, "секунди");
		СоответствиеПоЧислам.Вставить(5, "секунд");				
	ИначеЕсли Слово = "Раз" Тогда
		СоответствиеПоЧислам.Вставить(1, "раз");
		СоответствиеПоЧислам.Вставить(2, "рази");
		СоответствиеПоЧислам.Вставить(5, "раз");
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "рази");
			СоответствиеПоЧислам.Вставить(2, "раз");
			СоответствиеПоЧислам.Вставить(5, "раз");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "раз");
	...
	ИначеЕсли Слово = "Занятие" Тогда
		Если Падеж = "Родительный" Тогда 
			СоответствиеПоЧислам.Вставить(1, "заняття");
			СоответствиеПоЧислам.Вставить(2, "занять");
			СоответствиеПоЧислам.Вставить(5, "занять");
		Иначе 					
			СоответствиеПоЧислам.Вставить(1, "заняття");
			СоответствиеПоЧислам.Вставить(2, "заняття");
			СоответствиеПоЧислам.Вставить(5, "занять");
		КонецЕсли;
	ИначеЕсли Слово = "Посещение" Тогда
		СоответствиеПоЧислам.Вставить(1, "відвідування");
		СоответствиеПоЧислам.Вставить(2, "відвідування");
		СоответствиеПоЧислам.Вставить(5, "відвідувань");
	ИначеЕсли Слово = "Перенос" Тогда 
		СоответствиеПоЧислам.Вставить(1, "перенесення");
		СоответствиеПоЧислам.Вставить(2, "перенесення");
		СоответствиеПоЧислам.Вставить(5, "переносів");
	ИначеЕсли Слово = "Пропущенный" Тогда 
		СоответствиеПоЧислам.Вставить(1, "пропущений");
		СоответствиеПоЧислам.Вставить(2, "пропущених");
		СоответствиеПоЧислам.Вставить(5, "пропущених");
	ИначеЕсли Слово = "Просроченная" Тогда 
		СоответствиеПоЧислам.Вставить(1, "прострочена");
		СоответствиеПоЧислам.Вставить(2, "прострочені");
		СоответствиеПоЧислам.Вставить(5, "прострочених");		
	ИначеЕсли Слово = "Звонок" Тогда 
		СоответствиеПоЧислам.Вставить(1, "дзвінок");
		СоответствиеПоЧислам.Вставить(2, "дзвінка");
		СоответствиеПоЧислам.Вставить(5, "дзвінків");
	ИначеЕсли Слово = "Задача" Тогда 
		СоответствиеПоЧислам.Вставить(1, "задача");
		СоответствиеПоЧислам.Вставить(2, "завдання");
		СоответствиеПоЧислам.Вставить(5, "задач");
	ИначеЕсли Слово = "Сделка" Тогда 
		СоответствиеПоЧислам.Вставить(1, "угода");
		СоответствиеПоЧислам.Вставить(2, "угоди");
		СоответствиеПоЧислам.Вставить(5, "угод");
	ИначеЕсли Слово = "Новая" Тогда 
		СоответствиеПоЧислам.Вставить(1, "нова");
		СоответствиеПоЧислам.Вставить(2, "нові");
		СоответствиеПоЧислам.Вставить(5, "нових");
	ИначеЕсли Слово = "Обработанная" Тогда 
		СоответствиеПоЧислам.Вставить(1, "оброблена");
		СоответствиеПоЧислам.Вставить(2, "оброблені");
		СоответствиеПоЧислам.Вставить(5, "оброблених");
	ИначеЕсли Слово = "Ожидает" Тогда 
		СоответствиеПоЧислам.Вставить(1, "очікує");
		СоответствиеПоЧислам.Вставить(2, "очікують");
		СоответствиеПоЧислам.Вставить(5, "очікують");			
	КонецЕсли;
