...
Перем СтатусНетПроблем Экспорт;        // Статус нет проблем
Перем СтатусНеобходимАнализ Экспорт;   // Статус необходим анализ
Перем МножественноеЧисло Экспорт;      // Множественное число
Перем ЕдинственноеЧисло Экспорт;       // Единственное число
Перем МодулиПодсистем Экспорт;         // Модули подсистем
