...
Процедура ОтправитьНапоминаниеКлиентамОЗаписи() Экспорт
	// Вставить содержимое обработчика.
КонецПроцедуры

Процедура ОбработкаSMSСообщений() Экспорт
	...
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбработкаSMSСообщений);
	
	Попытка
		ОтказВыполнения = Ложь;	
		РегламентныеЗаданияСерверСтоматология.АктуализироватьЗаданиеОчереди(Метаданные.РегламентныеЗадания.ОбработкаSMSСообщений, Истина, , ОтказВыполнения);	
		Если ОтказВыполнения Тогда
			ОбщегоНазначения.ПриОкончанииВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбработкаSMSСообщений);			
			Возврат;
		КонецЕсли;
		
		Документы.РассылкаСообщений.ОтправкаОбновлениеСтатусовСообщений();
		ОбщегоНазначения.ПриОкончанииВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбработкаSMSСообщений);			
	Исключение
		ОписаниеОшибкиВыполнения = ОписаниеОшибки();
		ОбщегоНазначения.ПриОкончанииВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбработкаSMSСообщений, ОписаниеОшибкиВыполнения);		
	КонецПопытки;
