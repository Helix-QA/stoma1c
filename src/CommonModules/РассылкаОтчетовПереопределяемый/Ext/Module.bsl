...
Процедура ОпределитьИсключаемыеОтчеты(ИсключаемыеОтчеты) Экспорт
	...
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ДвиженияДокумента);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ОбъемНенужныхФайлов);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.МестаИспользованияСсылок);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ПроверкаЦелостностиТома);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.СведенияОПользователях);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.СогласияНаОбработкуПерсональныхДанныхДействующие);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.СогласияНаОбработкуПерсональныхДанныхИстекающие);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ДатыЗапретаЗагрузки);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ДатыЗапретаИзменения);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ПрогрессОтложенногоОбновления);	
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.УстановкаКритическихОстатков);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ПрайсЛист);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ПФ_MXL_КМ6);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.ИспользуемыеВнешниеРесурсы);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.АнализЖурналаРегистрации);
