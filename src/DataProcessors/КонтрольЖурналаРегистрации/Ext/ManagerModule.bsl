...
Процедура СформироватьОтчетПоОшибкамИПослатьОтчет(Знач НачалоПериодаВыборки = Неопределено,
	...
	ПараметрыПисьма.Вставить("Тема",
	                СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
	                  НСтр("ru = 'Контроль журнала регистрации: %1.'"), ПредставлениеИБ ));
	...
	ЭлектроннаяПочта.ОтправитьСообщение(ЭлектроннаяПочта.ПолучитьСистемнуюУчетнуюЗапись(),
							ПараметрыПисьма);
...
#Область БлокФункцийДляФормированияОтчета
