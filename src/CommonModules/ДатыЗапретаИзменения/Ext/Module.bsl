...
Процедура ПроверитьДатуЗапретаИзмененияПередЗаписьюДокумента(Источник, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	Если Источник.ДополнительныеСвойства.Свойство("НеПроверятьДатыЗапретаИзмененияДанных") 
		И Источник.ДополнительныеСвойства.НеПроверятьДатыЗапретаИзмененияДанных = Истина Тогда
		Возврат;
	КонецЕсли;
