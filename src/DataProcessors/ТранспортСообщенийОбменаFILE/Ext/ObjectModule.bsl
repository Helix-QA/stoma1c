...
Перем СтрокаСообщенияОбОшибке Экспорт; // Экспортная переменная СтрокаСообщенияОбОшибке
Перем СтрокаСообщенияОбОшибкеЖР Экспорт; // Экспортная переменная СтрокаСообщенияОбОшибкеЖР
