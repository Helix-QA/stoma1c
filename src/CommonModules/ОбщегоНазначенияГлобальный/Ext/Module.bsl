...
// Процедура - Оповестить о входящем звонке
//
Процедура ОповеститьОВходящемЗвонке() Экспорт
	ОбсужденияСистемыВзаимодействияКлиент.ОповеститьОВходящемЗвонкеКлиента();	
КонецПроцедуры
