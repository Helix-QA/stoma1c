...
Процедура ПроверитьУчетнуюЗапись(знач УчетнаяЗапись) Экспорт
	...
	Если УправлениеЭлектроннойПочтой.ПарольЗадан(УчетнаяЗапись) Тогда
...
Процедура ПроверитьУчетнуюЗаписьФрагмент(Знач ПарольПараметр, Знач УчетнаяЗапись)
	...
	УправлениеЭлектроннойПочтой.ПроверитьВозможностьОтправкиИПолученияЭлектроннойПочты(УчетнаяЗапись, ПарольПараметр, СообщениеОбОшибке, ДополнительноеСообщение);
