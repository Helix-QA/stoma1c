...
Функция ИменаСправочниковХраненияФайлов(ВладелецФайлов, НеВызыватьИсключение = Ложь) Экспорт
	...
	Если СтрНачинаетсяС(МетаданныеВладельца.Имя, "УведомлениеО") Тогда
		ИмяСтандартногоОсновногоСправочника = "МДЛППрисоединенныеФайлы";
	Иначе
...
Процедура ИзвлечьТекстИзФайловНаСервере() Экспорт
	...
	Попытка	
		...
		ОбщегоНазначения.ПриОкончанииВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ИзвлечениеТекста);			
	Исключение
		ОписаниеОшибкиВыполнения = ОписаниеОшибки();
		ОбщегоНазначения.ПриОкончанииВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ИзвлечениеТекста, ОписаниеОшибкиВыполнения);		
	КонецПопытки;
