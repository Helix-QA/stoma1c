...
//  ИмяОбработчикаПриПереходеДалее (необязательный) - Строка. Имя функции-обработчика события 
//															перехода на следующую страницу помощника.
//  ИмяОбработчикаПриПереходеНазад (необязательный) - Строка. Имя функции-обработчика события 
//															перехода на предыдущую страницу помощника.
