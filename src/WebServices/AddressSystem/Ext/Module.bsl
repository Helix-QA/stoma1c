...
Функция Ping(Locale, ConfigurationName)
	...
	Данные = Новый Структура("Данные", Неопределено);
...
Функция Autocomplete(Parent, Levels, Text, Limit, Locale, ConfigurationName)
	...
	СтруктураОбработки = Новый Структура("Данные", Новый ТаблицаЗначений); // АдресныйКлассификаторСлужебный.ТаблицаДанныхАвтоподбора() );
...
Функция Select(Parent, Level, Base, Sort, Limit, Locale, ConfigurationName)
	...
	АдресныйКлассификаторСлужебный.ЗаполнитьАдресаДляИнтерактивногоВыбораВнутр(СтруктураОбработки,Parent,Level,Уровни, ДополнительныеПараметры);	
...
Функция SelectByPostalCode(PostalCode, Levels, Base, Sort, Limit, Locale, ConfigurationName)
	...
	АдресныйКлассификаторСлужебный.ЗаполнитьАдресаПоПочтовомуИндексуКлассификатораВнутр(СтруктураОбработки, PostalCode, ДополнительныеПараметры);
