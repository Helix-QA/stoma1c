...
Процедура СохранитьПарольИПродолжитьВыполнить()
	...
	Если ПроверитьВозможностьОтправкиИПолучения Тогда
		...
		УправлениеЭлектроннойПочтой.ПроверитьВозможностьОтправкиИПолученияЭлектроннойПочты(УчетнаяЗапись, Пароль, СообщениеОбОшибке, ДополнительноеСообщение);
...
&НаКлиенте
Процедура СохранитьПарольИПродолжитьВыполнитьЗавершение(Пароль)
