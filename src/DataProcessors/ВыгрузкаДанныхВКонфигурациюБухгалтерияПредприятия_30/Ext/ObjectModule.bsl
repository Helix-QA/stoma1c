...
#Область ВспомогательныеПеременныеМоделяДляНаписанияАолгоритмов
...
#Область  ПеремещенныеМодуляОбработкиЗагрузки
...
#Область ВспомогательныеПоцедурыДляНаписанияАлгоритмов
...
#Область ПроцедурыИФункцииДляРаботыСОбъектомDOMXML
...
#Область ПроцедурыИФункуииРаботыСПротоколомОбмена  
...
// Параметры:
//  ПКО - Строка таблицы значений    - содержит правило конвертации объекта
//  ПравилаКонвертацииСвойствОбъекта - ТаблицаЗначений - содержит правила конвертации 
//  Свойств или группы свойств объекта из правила ПКО
//  ПКГС - Строка таблицы значений   - содержит правило конвертации группы свойств
//  
...
Функция НайтиОбъектПоСсылке(ТипОбъекта, 
	...
	ИначеЕсли (СвойствоУникальныйИдентификатор <> Неопределено) Тогда
		...
		// Не всегда нужно по уникальному идентификатору 
		// Новый элемент создавать, возможно нужно продолжить поиск
