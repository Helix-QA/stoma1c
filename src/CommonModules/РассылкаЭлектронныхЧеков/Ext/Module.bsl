...
//  ТипРассылки - Перечисления.ТипыРассылкиЭлектронного - Тип рассылки чека
...
// 
// Параметры:
//  ПараметрыСообщения - Структура - Со свойствами
//  * Адресат - Строка - Номер телефона или адреса электронной почты.
//  * ТипРассылки - Перечисления.ТипыРассылкиЭлектронного - Типы рассылки электронного чека.
//  * ПараметрыСообщения - Структура - Структура сообщения зависит от типа рассылки.
//  АдресРезультата - ХранилищеЗначений - Хранилище сохраняющее результаты выполнения.
// 
...
//
// Параметры:
//  Имя  - Строка - имя общего модуля, например: "ОбщегоНазначения", "ОбщегоНазначенияКлиент".
//
// Возвращаемое значение:
//  ОбщийМодуль
//
