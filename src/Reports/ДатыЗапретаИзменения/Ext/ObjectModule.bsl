...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ДатыЗапретаИзмененияПоПользователям"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ДатыЗапретаИзмененияПоПользователям"].ИмяМакетаОбразца = "ОбразецДатыЗапретаИзменения";
	
	НастройкиВариантов["ДатыЗапретаИзмененияПоПользователямБезРазделов"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ДатыЗапретаИзмененияПоПользователямБезРазделов"].ИмяМакетаОбразца = "ОбразецДатыЗапретаИзменения";
	
	НастройкиВариантов["ДатыЗапретаИзмененияПоПользователямБезОбъектов"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ДатыЗапретаИзмененияПоПользователямБезОбъектов"].ИмяМакетаОбразца = "ОбразецДатыЗапретаИзменения";
	
	НастройкиВариантов["ДатыЗапретаИзмененияПоРазделамОбъектамДляПользователей"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ДатыЗапретаИзмененияПоРазделамОбъектамДляПользователей"].ИмяМакетаОбразца = "ОбразецДатыЗапретаИзменения";
	
	НастройкиВариантов["ДатыЗапретаИзмененияПоОбъектамДляПользователей"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ДатыЗапретаИзмененияПоОбъектамДляПользователей"].ИмяМакетаОбразца = "ОбразецДатыЗапретаИзменения";
	
	НастройкиВариантов["ДатыЗапретаИзмененияПоРазделамДляПользователей"].Рекомендуемый    = Истина;	
	НастройкиВариантов["ДатыЗапретаИзмененияПоРазделамДляПользователей"].ИмяМакетаОбразца = "ОбразецДатыЗапретаИзменения";
...
Функция ТекстЗапроса()
	...
	|			НастроенныеПользователи.Пользователь КАК ГруппаПользователей
	|		ИЗ
	|			(ВЫБРАТЬ
	|				ДатыЗапретаИзменения.Пользователь КАК Пользователь
	|			ИЗ
	|				ДатыЗапретаИзменения КАК ДатыЗапретаИзменения
	|			ГДЕ
	|				ЛОЖЬ) КАК НастроенныеПользователи
	|		
	|		ОБЪЕДИНИТЬ
	|		
	|		ВЫБРАТЬ
	...
	|		ПО (ДатыЗапретаИзменения.Пользователь В (ЗНАЧЕНИЕ(Перечисление.ВидыНазначенияДатЗапрета.ДляВсехПользователей)))
