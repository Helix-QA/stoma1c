...
Процедура ПриЗаписи(Отказ)
	...
	УстанавливатьПоПометке 	= ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ДополнительныеСвойства, "УстанавливатьПоПометке"	, Ложь);
	
	РегистрыСведений.НастройкиВариантовОтчетов.ЗаписатьНастройкиДоступностиВариантаОтчета(
		Ссылка, ЭтоНовый, ПользователиВарианта, , , УстанавливатьПоПометке);
