...
Процедура ВыполнитьКоманду(Форма, Команда, ИмяТабличнойЧасти = Неопределено) Экспорт
	...
	Если СтрНачинаетсяС(Команда.Имя, "КонтекстноеМенюКартаЯндекс_") Тогда
		...
		УправлениеКонтактнойИнформациейКлиентСтоматология.ПоказатьАдресНаКарте(ДанныеКИ.Представление, "Яндекс.Карты");
	...
	ИначеЕсли СтрНачинаетсяС(Команда.Имя, "КонтекстноеМенюКартаGoogle_") Тогда
		...
		ДанныеКИ = Форма[ИмяТабличнойЧасти][ИндексКИ];
		УправлениеКонтактнойИнформациейКлиентСтоматология.ПоказатьАдресНаКарте(ДанныеКИ.Представление, "GoogleMaps");
	...
	ИначеЕсли СтрНачинаетсяС(Команда.Имя, "SkypeПозвонить_") Тогда
		...
		УправлениеКонтактнойИнформациейКлиентСтоматология.ПослеВыбораИзМенюSkype(Список[0], ДополнительныеПараметры);
