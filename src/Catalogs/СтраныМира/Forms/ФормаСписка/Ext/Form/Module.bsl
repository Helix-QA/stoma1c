...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаСоздать.Видимость  = МожноДобавлятьВСправочник;
	Если Не ДанныеКлассификатораДоступны Тогда
		...
		Если МожноДобавлятьВСправочник Тогда
			...
			Элементы.СоздатьЭлемент.ТолькоВоВсехДействиях     = Ложь;
			Элементы.СоздатьЭлемент.КнопкаПоУмолчанию         = Не РежимВыбора;
			Элементы.СоздатьЭлемент.Заголовок =               "";
		КонецЕсли;
