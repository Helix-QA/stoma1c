...
Процедура ПодготовитьОбластьИзВыгрузки(Знач КодОбластиДанных, Знач ИдентификаторВыгрузки, 
	...
	Попытка
		...
		Архив = РаботаВМоделиСервиса.ПрочитатьАрхив(ИдентификаторФайла);
		РаботаВМоделиСервиса.ИзвлечьФайл(Архив, "DumpInfo.xml", ВремКаталог);
...
Процедура ДобавитьЗаданиеПодготовитьОбластьИзВыгрузки(Знач КодОбластиДанных, Знач ИдентификаторВыгрузки,
	...
	ПараметрыЗадания.Вставить("ИнтервалПовтораПриАварийномЗавершении", 300); //5 минут
