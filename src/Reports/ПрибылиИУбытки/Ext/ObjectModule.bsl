...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ПрибылиИУбытки"].Рекомендуемый                    = Истина;
	НастройкиВариантов["ПрибылиИУбыткиПоВрачам"].Рекомендуемый            = Ложь;
	НастройкиВариантов["ПрибылиИУбыткиПоСпециализациям"].Рекомендуемый    = Ложь;
