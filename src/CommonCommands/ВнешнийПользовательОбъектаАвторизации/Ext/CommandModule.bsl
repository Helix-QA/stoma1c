...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ПользователиСлужебныйВызовСервера.ОбъектАвторизацииИспользуется(ПараметрКоманды, , НайденныйВнешнийПользователь, ЕстьПравоДобавленияВнешнегоПользователя) Тогда
