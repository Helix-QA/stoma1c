...
Функция СписокВариантовЗаполненияРасписаний() Экспорт
	...
	СписокВариантов.Добавить(1, НСтр("ru = 'Каждый день'; en = 'Everyday'"));
	СписокВариантов.Добавить(2, НСтр("ru = 'Каждый второй день'; en = 'Every second day'"));
	СписокВариантов.Добавить(3, НСтр("ru = 'Каждый четвертый день'; en = 'Every fourth day'"));
	СписокВариантов.Добавить(4, НСтр("ru = 'По будням'; en = 'On weekdays'"));
	СписокВариантов.Добавить(5, НСтр("ru = 'По выходным'; en = 'On weekends'"));
	СписокВариантов.Добавить(6, НСтр("ru = 'По понедельникам'; en = 'On Mondays'"));
	СписокВариантов.Добавить(7, НСтр("ru = 'По пятницам'; en = 'On Fridays'"));
	СписокВариантов.Добавить(8, НСтр("ru = 'По воскресеньям'; en = 'On Sundays'"));
	СписокВариантов.Добавить(9, НСтр("ru = 'В первый день месяца'; en = 'On the first day of the month'"));
	СписокВариантов.Добавить(10, НСтр("ru = 'В последний день месяца'; en = 'On the last day of the month'"));
	СписокВариантов.Добавить(11, НСтр("ru = 'Каждый квартал десятого числа'; en = 'Every quarter on the tenth'"));
	СписокВариантов.Добавить(12, НСтр("ru = 'Другое...'; en = 'Other...'"));
