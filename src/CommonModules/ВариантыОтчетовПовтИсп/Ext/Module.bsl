...
Функция ДоступныеОтчеты(ПроверятьФункциональныеОпции = Истина) Экспорт
	...
	Для Каждого ОтчетМетаданные Из Метаданные.Отчеты Цикл
		...
		Если ОтчетМетаданные.Имя = "ДвиженияДокумента" 
			Или ОтчетМетаданные.Имя = "ОбъемНенужныхФайлов"
			Или ОтчетМетаданные.Имя = "ПроверкаЦелостностиТома"
			Или ОтчетМетаданные.Имя = "СведенияОПользователях"
			Или ОтчетМетаданные.Имя = "СогласияНаОбработкуПерсональныхДанныхДействующие"
			Или ОтчетМетаданные.Имя = "СогласияНаОбработкуПерсональныхДанныхИстекающие" 
			Или ОтчетМетаданные.Имя = "ДатыЗапретаЗагрузки"
			Или ОтчетМетаданные.Имя = "ДатыЗапретаИзменения"
			Или ОтчетМетаданные.Имя = "ПрогрессОтложенногоОбновления" 
			Или ОтчетМетаданные.Имя = "УстановкаКритическихОстатков"
			Или ОтчетМетаданные.Имя = "ПрайсЛист"
			Или ОтчетМетаданные.Имя = "ПФ_MXL_КМ6"
			Или ОтчетМетаданные.Имя = "УниверсальныйОтчет"
			Или ОтчетМетаданные.Имя = "ИспользуемыеВнешниеРесурсы"
			Или ОтчетМетаданные.Имя = "АнализЖурналаРегистрации"
			Или ОтчетМетаданные.Имя = "ИнформацияПоКлиенту" 
			Тогда
			Продолжить;
		КонецЕсли;
