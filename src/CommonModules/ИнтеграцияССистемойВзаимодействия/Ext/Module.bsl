...
// Возвращает расшифрованные данные, предназначенные для 
// Управления системой взаимодействия через http-сервис
//
// Параметры:
...
// Версия платформы. Серверные методы, необходимые для регистрации базы 
// В системе взаимодействия, появились в этой версии платформы
// 
// Возвращаемое значение:
//  Строка - версия
//
