...
Функция ПользователиИБ(ИдентификаторыНесуществующихПользователейИБ)
	...
	Для каждого ПользовательИБ Из ВсеПользователиИБ Цикл
		...
		ПользователиСтоматология.ПрочитатьПользователяИБ(ПользовательИБ.УникальныйИдентификатор, СвойстваПользовательИБ);
...
Функция КонтактнаяИнформация(Настройки)
	...
	ТипыСсылки.Добавить(Тип("СправочникСсылка.Сотрудники"));
	...
	|ИЗ
	|	Справочник.Сотрудники.КонтактнаяИнформация КАК ПользователиКонтактнаяИнформация
	|ГДЕ
