...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Элементы.БИПГруппаОбновлениеПрограммы1.Видимость            = Ложь;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ПолучениеОбновленийПрограммы") Тогда
		...
		МодульПолучениеОбновленийПрограммы.ИнтернетПоддержкаИСервисы_ПриСозданииНаСервере(ЭтаФорма);
	Иначе
...
Процедура ПодключитьОтключитьОбсуждения(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("СтандартныеПодсистемы.Обсуждения") Тогда
		...
		Если ОбсужденияСистемыВзаимодействия.СистемаВзаимодействияВключена() Тогда 
			ОбсужденияСистемыВзаимодействияКлиент.ПоказатьОтключение();
		Иначе
			ОбсужденияСистемыВзаимодействияКлиент.ПоказатьПодключение();
		КонецЕсли;
...
&НаКлиенте
Процедура ПриоритетРаботаПользователейПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПриоритетОбработкаДанныхПриИзменении(Элемент)
...
&НаКлиенте
Процедура КоличествоПотоковОбновленияПриИзменении(Элемент)
