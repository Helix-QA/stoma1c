...
&НаКлиенте
Перем ОповещениеОбАвторизацииВСервисеОбновлений Экспорт;  // Оповещение об авторизации в сервисе обновлений
...
Процедура ЗаполнитьНачальныеНастройкиИОтображениеУстановкиКомпонентов()
	...
	Элементы.ГруппаАвтоматическаяУстановка.Видимость = Ложь;
