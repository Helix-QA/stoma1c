...
Перем ОбщийШаблон;	// Заполняется при формировании отчета табличным документом из макета "ОбщийШаблон" отчета
...
Процедура СформироватьОтчет(ТЧОтчета, знач СписокВерсий) Экспорт
	...
	ОбщийШаблон = Отчеты.ОтчетПоВерсиям.ПолучитьМакет("СтандартныйМакетПредставленияОбъекта");
...
Процедура СформироватьОтчетПоВерсииОбъекта(ТЧОтчета, ИдентификаторВерсии)
	...
	Если ОбщегоНазначения.ПроверитьСсылкаНаСправочник(СсылкаНаОбъект) Тогда
...
// функция производит точный поиск ВСЕГО ОКНА поиска ИскомыйШаблон(НачальнаяПозицияВОкнеПоиска,
//							ОконечнаяПозицияВОкнеПоиска) в границах поиска
...
Функция ПоискПодтаблицы(
                         ...
                         ОконечнаяПозицияВОкнеПоиска, // индекс последнего элемента в окне поиска 
                                                      // НачальнаяПозицияВОкнеПоиска и ОконечнаяПозицияВОкнеПоиска
													  //  определяют окно поиска
